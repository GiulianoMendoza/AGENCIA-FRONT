...
import { cart } from "../Products/ProductRender.js";
    ...
    products.forEach(product => {
        const productHTML = `
            <div class="producto" data-categoryname="${product.categoryName}">
                ...
                <button data-product-id="${product.id}" id="ver-mas-button" class="ver-mas"><a href="/Product.html" class="ver-mas-a"><p class="ver-mas-button">VER MÁS</p></a></button>
